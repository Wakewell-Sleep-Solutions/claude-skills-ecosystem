---
name: codex
description: "Run OpenAI Codex CLI for code analysis, auditing, refactoring, or automated editing. Use when user says 'run codex', 'codex exec', 'codex resume', 'codex audit', 'codex review', 'have codex check this', 'second opinion from codex', or references Codex for any code task. Also auto-triggers as audit hook after writing/modifying 50+ lines of code or any security/auth/crypto code, per the Codex Audit Hook protocol."
origin: ECC
---
